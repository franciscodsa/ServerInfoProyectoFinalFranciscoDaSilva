...
public class Constantes {
    ...
    public static final String ERROR_INESPERADO_AL_VALIDAR_TOKEN = "Error inesperado al validar token";
    public static final String NO_TIENE_ROL_PERMITIDO = "Permisos insuficientes";
}
